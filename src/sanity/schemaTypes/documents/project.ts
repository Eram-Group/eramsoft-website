...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: "projectType",
      title: "Project Type",
      description: "Controls which download/launch buttons appear on the detail page. Mobile shows App Store + Google Play; Website shows a single Visit Website button.",
      type: "string",
      options: {
        list: [
    ...
    defineField({
      name: "websiteUrl",
      title: "Website URL",
      description: "Shown as a 'Visit Website' button on the detail page. Only used when Project Type is Website. Leave empty to hide.",
      type: "url",
      hidden: ({ parent }) => parent?.projectType !== "website",
      validation: (r) => r.uri({ scheme: ["http", "https"] }),
    }),
    defineField({
      name: "appStoreUrl",
      title: "App Store URL",
      description: "Shown as an 'App Store' button on the detail page. Only used when Project Type is Mobile App. Leave empty to hide.",
      type: "url",
      hidden: ({ parent }) => parent?.projectType !== "mobile",
      validation: (r) => r.uri({ scheme: ["http", "https"] }),
    }),
    defineField({
      name: "playStoreUrl",
      title: "Google Play URL",
      description: "Shown as a 'Google Play' button on the detail page. Only used when Project Type is Mobile App. Leave empty to hide.",
      type: "url",
      hidden: ({ parent }) => parent?.projectType !== "mobile",
      validation: (r) => r.uri({ scheme: ["http", "https"] }),
    }),
