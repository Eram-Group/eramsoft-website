      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-12">
            ...
            <Link
              ...
              className={`relative text-[13px] font-medium tracking-widest transition-colors hover:text-[#50aaff] ${
                isActive(link.href)
                  ...
                  : isDark ? "text-white/50" : "text-foreground/60"
              }`}
            >
              {link.label}
            </Link>
        ...
        <div className="hidden items-center gap-4 md:flex">
          <div className="flex gap-2">
            {/* Facebook */}
            <a
              href="https://www.facebook.com/eramsoft"
              target="_blank"
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/company/eramsoft"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className={`flex h-8 w-8 items-center justify-center rounded-full transition-colors hover:text-[#50aaff] ${isDark ? "text-white/40" : "text-foreground/60"}`}
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/eramsoft"
              target="_blank"
              rel="noopener noreferrer"
        ...
        >
          <span className={`h-0.5 w-6 transition-transform ${isDark ? "bg-white/70" : "bg-foreground"} ${mobileOpen ? "translate-y-2 rotate-45" : ""}`} />
          <span className={`h-0.5 w-6 transition-opacity ${isDark ? "bg-white/70" : "bg-foreground"} ${mobileOpen ? "opacity-0" : ""}`} />
          <span className={`h-0.5 w-6 transition-transform ${isDark ? "bg-white/70" : "bg-foreground"} ${mobileOpen ? "-translate-y-2 -rotate-45" : ""}`} />
        </button>
      </div>
