    ...
    <section className="h2-surface relative flex min-h-screen flex-col overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 items-center px-8 pt-28 pb-8 lg:px-16">
        ...
        <div className="relative z-10 w-full max-w-xl">
          <p className="h2-subtitle mb-5 text-sm font-semibold tracking-[0.3em] uppercase h2-subtitleIn [animation-delay:0.2s]">
            Engineering Excellence
          </p>

          <h1 className="h2-heading mb-6 text-5xl font-bold leading-[1.08] md:text-6xl lg:text-[4.5rem] h2-clipReveal [animation-delay:0.45s]">
            We build<br />
            <span className="h2-shimmer">scalable</span>{" "}
            software.
          </h1>

          <p className="h2-body mb-10 max-w-md text-base leading-relaxed md:text-lg h2-fadeUp [animation-delay:0.8s]">
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center">
          <div className="h2-showcase">
            ...
            <div className="h2-browser h2-fadeUp [animation-delay:0.5s]">
            ...
            {/* ── Mobile Phone ── */}
            <div className="h2-phone h2-fadeUp [animation-delay:0.9s]">
            ...
            {/* ── Terminal ── */}
            <div className="h2-terminal h2-fadeUp [animation-delay:1.2s]">
            ...
            {/* ── Tech badge ── */}
            <div className="h2-tech-badge h2-fadeUp [animation-delay:1.4s]">
