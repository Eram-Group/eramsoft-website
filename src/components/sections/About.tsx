...
export default function About() {
  ...
  return (
    <section id="about" className="relative overflow-hidden bg-[#f5f2ee]">
      {/* Subtle grain */}
      <div
      ...
      <div ref={hero.ref} className="mx-auto max-w-6xl px-8 pt-28 pb-20 md:px-16 lg:px-24">
        <div className="grid grid-cols-1 gap-14 md:grid-cols-[1fr_1.2fr] md:gap-20">
          ...
          <div>
            ...
            >
              <span className="h-px w-8 bg-[#b8963e]/40" />
            ...
            >
              ...
              <br />
              <span className="text-[#b8963e]/80">forward</span>
            </h2>
          </div>
          ...
          >
            ...
            {/* Subtle divider */}
            <div className="mt-10 h-px w-16 bg-gradient-to-r from-[#b8963e]/30 to-transparent" />
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-6xl px-8 py-20 md:px-16 lg:px-24">
          <div className="grid grid-cols-1 gap-0 sm:grid-cols-2 lg:grid-cols-4">
            {CAPABILITIES.map((cap, i) => (
              ...
              >
                {/* Number */}
                <span className="mb-5 text-[11px] font-light tracking-[0.15em] text-[#b8963e]/50">
                  {cap.number}
                </span>
                ...
                {/* Hover accent line */}
                <div className="mt-6 h-px w-0 bg-[#b8963e]/30 transition-all duration-500 group-hover:w-10" />
              </div>
            ))}
          </div>
        </div>
